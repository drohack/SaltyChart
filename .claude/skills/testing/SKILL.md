...
| `T_NEGATIVE` | ~10-30 s | |
| `T_UI`, no `flows` | **~142 s** | all 28 flows; nothing stops early. No row does this any more |
...
backend twice per row (143 rows as of 2026-09-20) and starts real transcodes, which is not
...
Final line on success: `Pre-deploy: 18/18 passed - ready to build` (17/17 with
