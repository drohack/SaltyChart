"""
Pre-deploy unit test: 76-day season look-ahead logic.
...
def compute_initial_season(d: datetime) -> tuple[str, int]:
    """Mirror of computeInitialSeason() — 76-day look-ahead."""
...
CASES = [
    # 2026-01-15 → 76 days from Apr 1 = ~76 days; SPRING (within window)
    (datetime(2026, 1, 15), "SPRING", 2026,
     "76 days to Apr 1 → just inside lookahead window"),
    # 2026-01-01 → ~90 days from Apr 1 → still WINTER
    (datetime(2026, 1, 1), "WINTER", 2026,
     ">76 days to Apr 1 → stays in current season"),
